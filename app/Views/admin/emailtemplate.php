...
<section class="home">
  <div class="container">
    <div class="send-campaign">
      ...
      <form class="form-horizontal" action="<?= base_url('sendEmail') ?>" id="SubmitSendMail" method="post"
              ...
              <div class="card-body send-cam">
                ...
                <div class="form-group mb-3">
                  <div class="form-row row">
                    ...
                    <div class="col-xl-10 col-lg-10 col-md-10">
                      <input type="text" id="search" list="emailResults" class="form-control" style="height: 100px"
                        placeholder="Reciever Mail Id" name="search" autocomplete="off">
                ...
                <div class="form-group mb-3">
                  <div class="form-row row">
                    ...
                    <div class="col-xl-10 col-lg-10 col-md-10">
                      <input type="text" class="form-control" id="from" placeholder="xxx@gmail.com" name="From" readonly
                  ...
                  <div class="form-row row">
                    ...
                    <div class="col-xl-10 col-lg-10 col-md-10">
                      <input type="text" class="form-control" id="subject"
                        placeholder="Survey on H&C - New Hair Extension Campaign June 2023" name="subject"
                        autocomplete="off">
                    </div>
                  </div>
                </div>
                  ...
                  <div class="form-row row">
                    ...
                    <div class="col-xl-10 col-lg-10 col-md-10">
                      <select class="custom-select form-select custom-select-sm" class="custom-select custom-select-sm"
                        aria-label="Default select example" name="survey">
                ...
                <div class="form-group mt-4">
                  <div class="form-row row">
                    ...
                    <div class="col-xl-10 col-lg-10 col-md-10" style="text-align:center">
                      <input type="submit" name="submit" id="submit" class="btn btn-primary btn-block snd-mail-survey"
                        value="Send Mail" />
                    </div>
                  </div>
                </div>
