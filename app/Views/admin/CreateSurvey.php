      ...
      <form id="surveyForm" class="form-horizontal" action="<?= base_url('create_survey') ?>" method="post">
        <div class="form-group">
          ...
          <div class="campaign">
            ...
            <input id="campaign_name" name="campaign_name" type="text" placeholder="Survey Name" />
          ...
          <div class="campaign">
            ...
            <input id="placeholder_name" name="placeholder_name" type="text"
              placeholder="Company/Product/Service Name" />
        ...
        <div class="q-base">
          ...
          <p>For the second question, you have the opportunity to gather more detailed feedback. This question will vary
            depending on the respondent's Score to the first question, allowing you to tailor the follow-up based on
        ...
        <div class="que-glad">
          ...
          <div class="input-btn">
            <div class="dropdown">
              <input type="text" readonly id="drpdwn-button-1" autocomplete="off"
                placeholder="Please Choose from the list" class="dropdown-button form-select-1" />
              ...
              <div class="dropdown-content-1">
                <div class="drp-down-ans t_answer2">
                  <?php foreach ($answerList[0] as $answer) { ?>
                    <label id="<?php echo stripslashes($answer['answer_id']); ?>c1" class="checkbox-item"><input
                        type="checkbox" name="ans_2[]" value="<?php echo stripslashes($answer['answer_id']); ?>">
                      <?php echo stripslashes($answer['answer_name']); ?>
                      <div class="ed-de-an">
                        <?php if ($tenantData['tenant_id'] == 1) { ?>
                          <a href="#" class="edit-del-Answer"
                            onclick="editAnswer(<?php echo stripslashes($answer['answer_id']); ?>,'<?php echo stripslashes($answer['answer_name']); ?>',1)">
                            <img src="<?php echo base_url(); ?>images/icons/Edit.png" class="img-centered img-fluid">
                          </a>
                          <a href="#" class="edit-del-Answer"
                            onclick="alertModal(<?php echo stripslashes($answer['answer_id']); ?>,1)">
                ...
                <?php if ($tenantData['tenant_id'] > 1) { ?>
                  <div class="drp-custom-ans">
                    ...
                    <div class="drp-down-ans c_answer2">
                      <button type="button" onclick="AddPrevAnswers(1)" id="AddPrevAnswers1"><span
                          class="glyphicon glyphicon-plus">Add previous survey answers</span></button>
          ...
          <div class="hidden-div" id="myDiv1" style="display:none">
            <div class="ans-up">
              ...
              <div>
                ...
                <button class="updateButton" onclick="addAnswer(document.getElementById('c_answer1').value,1,2)"
            ...
            <div class="ans-up">
              ...
              <div>
                ...
                <button class="updateButton"
                  onclick="editAnswer1(document.getElementById('e_id1').value,document.getElementById('e_answer1').value,1)"
                  type="button">Update</button>
        ...
        <div class="que-glad">
          ...
          <div class="input-btn">
            ...
            <div class="dropdown">
              <input type="text" readonly id="drpdwn-button-2" autocomplete="off"
                placeholder="Please Choose from the list" class="dropdown-button-2 form-select-1" />
              <div style="color: red;font-size: 12px; display:none;" id="errorQuestion3"></div>
              <div class="dropdown-content-2 ">
                <div class="drp-down-ans t_answer3">
                  <?php foreach ($answerList[0] as $answer) { ?>
                    <label id="<?php echo stripslashes($answer['answer_id']); ?>c2" class="checkbox-item"><input
                        type="checkbox" name="ans_3[]" value="<?php echo stripslashes($answer['answer_id']); ?>">
                      <?php echo stripslashes($answer['answer_name']); ?>
                      <div class="ed-de-an">
                        <?php if ($tenantData['tenant_id'] == 1) { ?>
                          <a href="#"
                            onclick="editAnswer(<?php echo stripslashes($answer['answer_id']); ?>,'<?php echo stripslashes($answer['answer_name']); ?>',2)"
                            class="edit-del-Answer">
                            <img src="<?php echo base_url(); ?>images/icons/Edit.png" class="img-centered img-fluid">
                          </a>
                          <a href="#" class="edit-del-Answer"
                            onclick="alertModal(<?php echo stripslashes($answer['answer_id']); ?>,2)">
                            <img src="<?php echo base_url(); ?>images/icons/Trash.png" class="img-centered img-fluid">
                          </a>
                        <?php } ?>
                      </div>
                ...
                <?php if ($tenantData['tenant_id'] > 1) { ?>
                  <div class="drp-custom-ans">
                    ...
                    <div class="drp-down-ans c_answer3">
                      <button type="button" onclick="AddPrevAnswers(2)" id="AddPrevAnswers2"><span
                          class="glyphicon glyphicon-plus">Add previous survey answers</span></button>
          ...
          <div class="hidden-div" id="myDiv2" style="display:none">
            <div class="ans-up">
              ...
              <div>
                ...
                <button class="updateButton" onclick="addAnswer(document.getElementById('c_answer2').value,2,3)"
                  type="button">Update</button>
          ...
          <div class="hidden-div" id="editDiv2">
            <div class="ans-up">
              ...
              <div>
                ...
                <button class="updateButton"
                  onclick="editAnswer1(document.getElementById('e_id2').value,document.getElementById('e_answer2').value,2)"
                  type="button">Update</button>
        ...
        <div class="que-glad">
          ...
          <div class="input-btn">
            ...
            <div class="dropdown">
              <input type="text" readonly id="drpdwn-button-3" autocomplete="off"
                placeholder="Please Choose from the list" class="dropdown-button-3 form-select-1" />
              ...
              <div class="dropdown-content-3 ">
                <div class="drp-down-ans t_answer4">
                  <?php foreach ($answerList[0] as $answer) { ?>
                    <label id="<?php echo stripslashes($answer['answer_id']); ?>c3" class="checkbox-item"><input
                        type="checkbox" name="ans_4[]" value="<?php echo stripslashes($answer['answer_id']); ?>">
                      <?php echo stripslashes($answer['answer_name']); ?>
                      <div class="ed-de-an">
                        <?php if ($tenantData['tenant_id'] == 1) { ?>
                          <a href="#"
                            onclick="editAnswer(<?php echo stripslashes($answer['answer_id']); ?>,'<?php echo stripslashes($answer['answer_name']); ?>',3)"
                            class="edit-del-Answer">
                            <img src="<?php echo base_url(); ?>images/icons/Edit.png" class="img-centered img-fluid">
                          </a>
                          <a href="#" class="edit-del-Answer"
                            onclick="alertModal(<?php echo stripslashes($answer['answer_id']); ?>,3)">
                            <img src="<?php echo base_url(); ?>images/icons/Trash.png" class="img-centered img-fluid">
                          </a>
                        <?php } ?>
                      </div>
                ...
                <?php if ($tenantData['tenant_id'] > 1) { ?>
                  <div class="drp-custom-ans" id="">
                    ...
                    <div class="drp-down-ans c_answer4">
                      <button type="button" onclick="AddPrevAnswers(3)" id="AddPrevAnswers3"><span
                          class="glyphicon glyphicon-plus">Add previous survey answers</span></button>
          ...
          <div class="hidden-div" id="myDiv3" style="display:none">
            <div class="ans-up">
              ...
              <div>
                ...
                <button class="updateButton" onclick="addAnswer(document.getElementById('c_answer3').value,3,4)"
                  type="button">Update</button>
          ...
          <div class="hidden-div" id="editDiv3">
            <div class="ans-up">
              ...
              <div>
                ...
                <button class="updateButton"
                  onclick="editAnswer1(document.getElementById('e_id3').value,document.getElementById('e_answer3').value,3)"
                  type="button">Update</button>
