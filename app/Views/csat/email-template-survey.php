...
<body>
    <?php
    $url = base_url() . "csat/getSurveyQuestion/" . $contactdata["id"] . "/" . $postdata['survey'] . "/" . $userId . "/" . $tenantdata['tenant_id'];// . "/" . $surveyrandom;
            ...
            <div style="max-width: 794px;
                ...
                <div style="margin: auto;text-align: center;">
                    <h3 style="color: #000;
                                ...
                                font-style: normal;
                                text-align: left;
                                font-weight: 600;">How likely is it that you would recommend  to a friend or colleague?
                    </h3>
                </div>
