            ...
            <ul class="menu-links" id="menu">
                ...
                <li class="nav-link">
                    <a href="<?php echo site_url('reports'); ?>" onclick="setActive(2)">
                        ...
                        echo img($imageProperties); ?>
                        <span class="text nav-text">Survey Reports</span>
                    </a>
                </li>
                ...
                <li class="nav-link">
                    <a href="<?php echo site_url('SurveyResponse'); ?>" onclick="setActive(4)">
                        ...
                        echo img($imageProperties); ?>
                        <span class="text nav-text">Survey Response</span>
                    </a>
                </li>
                ...
                <li class="nav-link">
                    <a href="<?php echo site_url('emailtemplate'); ?>" onclick="setActive(5)">
                        ...
                        echo img($imageProperties); ?>
                        <span class="text nav-text">Send Survey</span>
                    </a>
                </li>
                <?php if (session()->get('tenant_id') != 1) { ?>
                    <li class="nav-link">
                ...
                <?php } ?>
                <li class="nav-link">
                    <a href="<?php echo site_url('csat/questionList'); ?>" onclick="setActive(7)">
                        <?php $imageProperties = ['src' => 'images/icons/1.png', 'class' => 'img-fluid'];
                        echo img($imageProperties); ?>
                        <span class="text nav-text">CSAT-Question list</span>
                    </a>
                </li>
                <li class="nav-link">
                    <a href="<?php echo site_url('csat/answerList'); ?>" onclick="setActive(8)">
                        <?php $imageProperties = ['src' => 'images/icons/1.png', 'class' => 'img-fluid'];
                        echo img($imageProperties); ?>
                        <span class="text nav-text">CSAT-Answer list</span>
                    </a>
                </li>
                <li class="nav-link">
                    <a href="<?php echo site_url('csat/surveyList'); ?>" onclick="setActive(9)">
                        <?php $imageProperties = ['src' => 'images/icons/1.png', 'class' => 'img-fluid'];
                        echo img($imageProperties); ?>
                        <span class="text nav-text">CSAT-Survey Management</span>
                    </a>
                </li>
                <li class="nav-link">
                    <a href="<?php echo site_url('csat/sendSurvey'); ?>" onclick="setActive(10)">
                        <?php $imageProperties = ['src' => 'images/icons/1.png', 'class' => 'img-fluid'];
                        echo img($imageProperties); ?>
                        <span class="text nav-text">CSAT-Send Survey</span>
                    </a>
                </li>
                <li class="nav-link">
                    <a href="<?php echo site_url('csat/surveyResponse'); ?>" onclick="setActive(10)">
                        <?php $imageProperties = ['src' => 'images/icons/1.png', 'class' => 'img-fluid'];
                        echo img($imageProperties); ?>
                        <span class="text nav-text">CSAT-Survey response</span>
                    </a>
                </li>
